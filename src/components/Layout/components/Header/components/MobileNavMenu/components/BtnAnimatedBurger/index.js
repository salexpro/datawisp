...
const BtnAnimatedBurger = React.forwardRef((props, ref) => {
  return (
    ...
    >
      ...
      >
        <path
          className={classNames(s.hamb_line, s.hamb_line_top)}
          d="M4 8h16 c1 0 3 .4 3 2s-2 2-3 2 h-8"
        />
        <path
          className={classNames(s.hamb_line, s.hamb_line_middle)}
          d="M4 12 h16"
        />
        <path
          className={classNames(s.hamb_line, s.hamb_line_bottom)}
